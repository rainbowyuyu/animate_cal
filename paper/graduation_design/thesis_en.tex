...
\includegraphics[width=5.75764in,height=2.5375in,alt={智算视界}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image1.png}
...
This course design aims to develop and research a handwriting matrix
...
\begin{figure}
\centering
\includegraphics[width=3.93701in,height=4.11707in,alt={形状, 箭头 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image2.png}
...
\bottomrule\noalign{}
\endlastfoot
\includegraphics[width=1.575in,height=1.54375in,alt={image\_50004}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image3.jpeg}

Figure 3.2 Sample images generated by v0 &
\includegraphics[width=1.575in,height=1.54306in,alt={图示, 工程绘图 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image4.png}
...
\bottomrule\noalign{}
\endlastfoot
\includegraphics[width=1.37569in,height=1.575in,alt={image\_90007}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image5.png}

Figure 3.4 Sample images generated by v1 &
\includegraphics[width=1.38472in,height=1.575in,alt={图示 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image6.png}
...
\bottomrule\noalign{}
\endlastfoot
\includegraphics[width=1.97222in,height=1.575in,alt={alpha\_50001}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image7.png}

Figure 3.6 Example of alpha pattern generated by v2 &
\includegraphics[width=1.95139in,height=1.575in,alt={图示 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image8.png}

Figure 3.7 Sample alpha annotation generated by v2 \\
\includegraphics[width=1.96875in,height=1.33194in,alt={horizontal\_57756}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image9.png}

Figure 3.8 Matrix element pattern generated by v2 &
\includegraphics[width=1.96875in,height=1.35694in,alt={图片包含 图示 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image10.png}

Figure 3.9 Sample matrix element labeling generated by v2 \\
\includegraphics[width=2.75625in,height=0.87639in,alt={matrix\_59157}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image11.png}

Figure 3.10 Matrix pattern generated by v2 &
\includegraphics[width=2.75625in,height=0.94722in,alt={图示 中度可信度描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image12.png}
...
\bottomrule\noalign{}
\endlastfoot
\includegraphics[width=2.85625in,height=1.53125in,alt={matrix\_90048}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image13.png}

Figure 3.12 Matrix pattern generated by v3 &
\includegraphics[width=2.75625in,height=1.53056in,alt={白板上写着字 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image14.png}
...
\bottomrule\noalign{}
\endlastfoot
\includegraphics[width=2.75625in,height=1.57569in,alt={matrix\_94875}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image15.png}

Figure 3.14 Matrix pattern generated by v4 &
\includegraphics[width=2.67639in,height=1.575in,alt={白板上的字 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image16.png}
...
\begin{figure}
\centering
\includegraphics[width=4.72441in,height=4.39465in,alt={文本, 形状 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image17.png}
...
\begin{figure}
\centering
\includegraphics[width=3.93681in,height=2.91597in,alt={数据集生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image18.png}
...
\begin{figure}
\centering
\includegraphics[width=3.93681in,height=3.23542in,alt={yolo-mamba}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image19.png}
...
\begin{figure}
\centering
\includegraphics[width=5.51181in,height=0.43958in,alt={CA流程}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image20.png}
...
& (1) \\
\includegraphics[width=1.575in,height=1.18403in,alt={白板上写着字 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image21.png}

artwork master &
\includegraphics[width=1.96875in,height=1.16667in,alt={白板上的文字 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image22.png}

PSA module &
\multicolumn{2}{>{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.3322} + 2\tabcolsep}@{}}{%
\includegraphics[width=1.96875in,height=1.16042in,alt={白板上的文字 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image23.png}
...
\bottomrule\noalign{}
\endlastfoot
\includegraphics[width=2.6125in,height=2.08472in,alt={confusion\_matrix}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image24.png}

Figure 4.4 Matrix pattern generated by v4 &
F\includegraphics[width=3.25486in,height=2.09792in,alt={results}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image25.png}igure
...
\includegraphics[width=4.52847in,height=1.13333in,alt={预处理流程图}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image26.png}
...
\bottomrule\noalign{}
\endlastfoot
\includegraphics[width=1.9625in,height=0.99931in,alt={白板上写着字 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image27.jpeg}

artwork master &
\includegraphics[width=1.96736in,height=0.96458in,alt={白板上的字 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image28.png}
...
\bottomrule\noalign{}
\endlastfoot
\includegraphics[width=2.05486in,height=1.29861in]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image29.jpeg}

artwork master &
\includegraphics[width=1.96806in,height=1.17639in,alt={白板上的文字 中度可信度描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image30.png}
...
\includegraphics[width=3.93681in,height=1.02986in,alt={图示 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image31.png}
...
\bottomrule\noalign{}
\endlastfoot
\includegraphics[width=2.47917in,height=1.44236in,alt={白板上写着字 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image29.jpeg}

artwork master &
\includegraphics[width=2.40139in,height=1.49097in,alt={游戏界面 中度可信度描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image32.png}
...
\bottomrule\noalign{}
\endlastfoot
\includegraphics[width=1.57431in,height=1.17986in,alt={白板上写着字 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image33.jpeg}

artwork master &
\includegraphics[width=1.77153in,height=1.05903in,alt={图示 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image34.png}

Split line results &
\includegraphics[width=1.77153in,height=0.99653in,alt={形状 中度可信度描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image35.png}
...
\includegraphics[width=4.03472in,height=3.5125in,alt={类对象继承}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image36.png}
...
\includegraphics[width=3.64583in,height=2.04722in,alt={形状 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image37.png}
...
\includegraphics[width=3.93681in,height=1.96181in,alt={文本 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image38.png}
...
\includegraphics[width=3.64514in,height=2.04583in,alt={图片包含 日历 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image39.png}
...
\includegraphics[width=3.33819in,height=2.77222in,alt={文本 中度可信度描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image40.png}
...
\includegraphics[width=3.22639in,height=1.81042in,alt={日历 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image41.png}
...
\includegraphics[width=3.87569in,height=1.45139in,alt={文本 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image42.png}
...
\includegraphics[width=3.56806in,height=2.00208in,alt={图片包含 日历 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image43.png}
...
\includegraphics[width=3.65278in,height=2.00903in,alt={图示 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image44.png}

Figure 4.17 Step-by-step algorithm flow chart for determinant

\includegraphics[width=5.70833in,height=2.08333in,alt={图形用户界面, 日程表 中度可信度描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image45.png}
...
\includegraphics[width=3.93681in,height=1.27292in,alt={文本 中度可信度描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image46.png}
...
\includegraphics[width=3.69375in,height=2.07292in,alt={日历 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image47.png}

Figure 4.19 An example of a frame of addition in MatrixMath

\includegraphics[width=3.73056in,height=2.09375in,alt={图形用户界面 中度可信度描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image48.png}
...
\bottomrule\noalign{}
\endlastfoot
\includegraphics[width=3.05417in,height=2.08819in,alt={图示 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image49.png}

Figure 4.21 Flowchart of the algorithm for step-by-step demonstration of
matrix addition &
\includegraphics[width=2.69167in,height=2.20486in,alt={图示 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image50.png}
...
\pandocbounded{\includegraphics[keepaspectratio]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image51.wmf}}by
...
\bottomrule\noalign{}
\endlastfoot
\includegraphics[width=3.01667in,height=1.90486in,alt={图示 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image52.png}

Figure 4.23 Flowchart of the algorithm for matrix multiplication step by
step &
\includegraphics[width=3.14306in,height=2.04583in,alt={图示 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image53.png}
...
\includegraphics[width=3.14961in,height=3.34754in,alt={yolo网络}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image54.png}
...
\bottomrule\noalign{}
\endlastfoot
\includegraphics[width=3.41944in,height=2.51736in,alt={图示 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image55.png}

Figure 7.1 User operation flow chart &
\includegraphics[width=2.075in,height=2.60278in,alt={文本 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image56.png}
...
\bottomrule\noalign{}
\endlastfoot
\includegraphics[width=3.56667in,height=1.84861in,alt={输入与处理}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image57.jpeg}
&
\includegraphics[width=1.69028in,height=2.04653in]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image58.png} \\
...
\includegraphics[width=4.72431in,height=2.44792in,alt={计算}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image59.jpeg}
...
\includegraphics[width=4.72431in,height=2.44792in,alt={手写输入}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image60.jpeg}
...
\includegraphics[width=4.92847in,height=1.99931in,alt={图示 描述已自动生成}]{E:/python_project/animate_cal/paper/graduation_design/media_en/media/image61.png}
